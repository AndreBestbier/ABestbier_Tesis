...
% \usepackage[numbers]{natbib} %%<<<<<<<<<< Vancouver
...
\usepackage{float}%>>>>>>>>>>>Trying ti fix figure pos
...
%==== TITLE PAGE ====================================================
\title{\bfseries
       \AorE{Monitering van kern temperatuur, hartklop, respiratoriese tempo, bloed suurstof versadiging en EEG deur middel van 'n draadlose oor probe\\[1ex]\normalfont\small\itshape(``Monitoring core temperature, heart rate, respiratory rate, blood oxygen saturation and EEG through a wireless ear probe'')
            }
            {Monitoring core temperature, heart rate, respiratory rate, blood oxygen saturation and EEG through a wireless ear probe}
            }
